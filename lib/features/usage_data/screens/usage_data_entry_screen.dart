...
class _UsageDataEntryScreenState extends State<UsageDataEntryScreen>
              ...
              return GestureDetector(
                onTap: () {
                  setState(() {
                    ...
                    _selectedType =
                        UsageType.getTypesForCategory(category).first;
            ...
            return GestureDetector(
              ...
              child: AnimatedContainer(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(
                    color:
                        isSelected ? Colors.transparent : AppColors.inputBorder,
                  ),
                  boxShadow: isSelected
                      ? AppShadows.buttonShadow
                      : AppShadows.softShadow,
  ...
  Widget _buildEmissionPreview() {
    ...
    final emission =
        _selectedType != null ? _selectedType!.baseEmissionFactor * value : 0.0;
                ...
                Row(
                  ...
                  children: [
                    Text(
                      ...
                      style: AppTextStyles.heading2.copyWith(
                        color:
                            emission > 0 ? Colors.white : AppColors.textLight,
                      ),
                    ),
